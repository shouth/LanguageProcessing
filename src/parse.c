...
static int at_any(struct parser *p, toks_t const *kinds)
{
...
static int check_any(struct parser *p, toks_t const *kinds)
{
...
static int eat_any(struct parser *p, toks_t const *kinds)
{
...
static int expect_any(struct parser *p, toks_t const *kinds)
{
  if (eat_any(p, kinds)) {
    return 1;
  } else {
...
static void bogus(struct parser *p, syn_ckpt_t ckpt, enum syn_kind kind, toks_t const *recovery)
{
...
static void parse_expr(struct parser *p, toks_t const *sync);

static void parse_type(struct parser *p, toks_t const *recovery)
{
...
static void parse_expr_with_power(struct parser *p, toks_t const *recovery, int power)
{
...
static void parse_expr(struct parser *p, toks_t const *recovery)
{
  parse_expr_with_power(p, recovery, 0);
}

static void parse_stmt(struct parser *p, toks_t const *recovery);

static void parse_assign_stmt(struct parser *p, toks_t const *recovery)
{
...
static void parse_if_stmt(struct parser *p, toks_t const *recovery)
{
...
static void parse_while_stmt(struct parser *p, toks_t const *recovery)
{
...
static void parse_act_params(struct parser *p, toks_t const *recovery)
{
...
static void parse_call_stmt(struct parser *p, toks_t const *recovery)
{
...
static void parse_input_stmt(struct parser *p, toks_t const *recovery)
{
...
static void parse_output_value(struct parser *p, toks_t const *recovery)
{
...
static void parse_output_values(struct parser *p, toks_t const *recovery)
{
...
static void parse_output_stmt(struct parser *p, toks_t const *recovery)
{
...
static void parse_comp_stmt(struct parser *p, toks_t const *recovery)
{
...
static void parse_ident_list(struct parser *p, toks_t const *next, toks_t const *recovery)
{
...
static void parse_var_decl(struct parser *p, toks_t const *recovery)
{
...
static void parse_var_decl_part(struct parser *p, toks_t const *next, toks_t const *recovery)
{
...
static void parse_fml_params(struct parser *p, toks_t const *recovery)
{
...
static void parse_proc_decl_head(struct parser *p, toks_t const *recovery)
{
...
static void parse_proc_decl_part(struct parser *p, toks_t const *recovery)
{
...
static void parse_block(struct parser *p, toks_t const *recovery)
{
