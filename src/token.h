...
typedef enum {
  TOKEN_TYPE_INDEX_KEYWORD,
  TOKEN_TYPE_INDEX_TOKEN,
  TOKEN_TYPE_INDEX_ERROR,

  TOKEN_TYPE_COUNT
} token_type_index_t;

#define token_type(kind) (kind & 0xFF00)

typedef enum {
  TOKEN_TYPE_KEYWORD = TOKEN_TYPE_INDEX_KEYWORD << 8,
  ...
  TOKEN_TYPE_TOKEN = TOKEN_TYPE_INDEX_TOKEN << 8,
  ...
  TOKEN_TYPE_ERROR = TOKEN_TYPE_INDEX_ERROR << 8,
