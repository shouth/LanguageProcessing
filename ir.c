...
ir_rvalue_t *new_ir_binary_op_rvalue(binary_op_kind_t kind, ir_operand_t *lhs, ir_operand_t *rhs)
{
    ir_rvalue_t *ret;
    assert(lhs && rhs);
...
ir_rvalue_t *new_ir_unary_op_rvalue(unary_op_kind_t kind, ir_operand_t *value)
{
    ir_rvalue_t *ret;
    assert(value);
